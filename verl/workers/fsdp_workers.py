...
from verl.workers.actor.dp_actor import DataParallelPPOActor, create_device_mesh, get_sharding_strategy
...
class ActorRolloutRefWorker(Worker):
    ...
    def update_actor(self, data: DataProto):
        ...
        if self._is_offload_param:
            self.actor.to(tag="model", device="gpu")
        if self._is_offload_optimizer:
    ...
    def compute_ref_log_prob(self, data: DataProto):
        ...
        self.ref_policy.reshard_root_module()
    ...
    def save_checkpoint(self, local_path, hdfs_path=None, global_step=0, max_ckpt_to_keep=None):
        ...
        self.actor.save_checkpoint(local_path=local_path, hdfs_path=hdfs_path, global_step=global_step, max_ckpt_to_keep=max_ckpt_to_keep)
    ...
    def load_checkpoint(self, local_path, hdfs_path=None, del_local_after_load=False):
        ...
        self.actor.load_checkpoint(local_path=local_path, hdfs_path=hdfs_path, del_local_after_load=del_local_after_load)
